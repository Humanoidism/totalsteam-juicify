...
# ## *sbuild*
#
# Builds Source (for Better CoffeeScript)
#
# <small>Usage</small>
#
# ```
# cake sbuild
# ```
task 'sbuild', 'compile source', -> build -> log ":)"
...
#
log = (message, color, explanation) -> console.log (color or '') + message + (if color then reset else '') + ' ' + (explanation or '')
